...
Today (Dec. 3, 2025), I nudged Gemini CLI to do better than what I discussed in [Part 1](ql_md_template.html?my.md=coding/AI/what-wrong-w-ai-codes.md).

If you are careful and give the proper commands to Gemini CLI, it can perform better with styles. Unfortunately, LLM-AI cannot reason and come up with the solution for speeding up the double loops as I mentioned in [Part 1](ql_md_template.html?my.md=coding/AI/what-wrong-w-ai-codes.md).
...
analyse [what-wrong-w-ai-codes.md](ql_md_template.html?my.md=coding/AI/what-wrong-w-ai-codes.md) and update the style file
